...
export function GiraffeArt() {
  return <>
    <div style={p('16%','48%','40%','26%',{borderRadius:'50%',background:'#E6BB63',boxShadow:'inset -5px -5px 0 rgba(150,100,30,0.16)'})}/>
...
export function HoneyArt() {
  return <>
    ...
    <div style={p('68%','12%','24%','17%',{borderRadius:'50%',background:'#F4C84A',overflow:'hidden',boxShadow:'inset -3px -3px 0 rgba(150,100,20,0.18)'})}>
    ...
    <div style={p('87%','16%','4%','5%',{borderRadius:'50%',background:'#4A3A28'})}/>
  </>
}
...
export function BatArt() {
  return <>
    ...
    <div style={p('32%','30%','36%','40%',{borderRadius:'48% 48% 46% 46%',background:'#7A66A0',boxShadow:'inset -5px -5px 0 rgba(50,38,80,0.20)'})}/>
...
export function JoeyArt() {
  return <>
    ...
    <div style={p('36%','34%','34%','40%',{borderRadius:'50% 52% 46% 48%',background:'#DBAA6C',boxShadow:'inset -5px -4px 0 rgba(140,95,40,0.16)'})}/>
...
export function OctopusArt() {
  return <>
    ...
    <div style={p('20%','16%','60%','50%',{borderRadius:'50% 50% 44% 44%',background:'#D67BA0',boxShadow:'inset -6px -6px 0 rgba(120,40,80,0.16)'})}/>
